                ...
                <div class="row">
                    <div
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                @php
                                    $sessionData = session('form_harga', []);
                                @endphp
                                <form id="formSurveyHarga" method="POST"
                                    action="{{ route('post-form-pertanyaan-harga') }}">
                                    @csrf

                                    @foreach ($pertanyaanFormHarga as $pertanyaan)
                                            ...
                                            @switch($tipeId)
                                                ...
                                                @case(2)
                                                    ...
                                                    @php
                                                        ...
                                                        $batasPilihan = $pertanyaan->batas_pilihan;
                                                    @endphp

                                                    <div class="checkbox-wrapper" data-question-id="{{ $pertanyaan->id }}"
                                                        data-batas-pilihan="{{ $batasPilihan }}">
                                                        @foreach ($pertanyaan->options as $option)
                                                            @php
                                                                $isOther = $option->is_other;
                                                                $isChecked =
                                    ...
                                    <div class="form-group d-flex justify-content-between">
                                        <a href="#" class="btn btn-outline-warning"
                                            onclick="document.getElementById('formSurveyHarga').reset(); return false;">Clear
                                            Form</a>

                                        <div class="d-flex" style="gap: 10px;">
                                            <a href="{{ route('form-pertanyaan-kualitas') }}"
